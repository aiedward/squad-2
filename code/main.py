...
tf.app.flags.DEFINE_integer("context_len", 325, "The maximum context length of your model")
tf.app.flags.DEFINE_integer("question_len", 23, "The maximum question length of your model")
