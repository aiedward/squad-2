...
from modules import RNNEncoder, SimpleSoftmaxLayer, Coattention, BiLSTMEncoder, SelfAttention
...
class QAModel(object):
    ...
    def build_graph(self):
        ...
        coattn_RNN_output = self_attention_layer.build_graph(coattn_RNN_output)
